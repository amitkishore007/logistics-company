...
CREATE TABLE `contactus` (
  ...
  `con_addre` varchar(512) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `contactus` (`con_id`, `con_name`, `con_num`, `con_email`, `site`, `pin`, `con_addre`) VALUES
(1, 'mike', '7012561424', 'mike@gmail.com', 'www.mike.co.in', '110024', 'New Delhi Dwarka mor ');
...
INSERT INTO `demo` (`id`, `name`, `email`, `date`, `city`, `message`) VALUES
(1, '$name', '$email', '$demo', '$date', '$message'),
(2, 'bvxcb', 'sharmasunita0101@gmail.com', 'Wait Loss', 'sdfsdf', 'dfsdfsdf'),
(3, 'gfdgsdfg', 'sharmasunita0101@gmail.com', 'Wait Loss', 'dsfsf', 'dsfsdfsadf');
...
CREATE TABLE `partner` (
  ...
  `regis_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `partner` (`id`, `company_name`, `person_name`, `regis_date`, `company_website`, `country`, `state`, `city`, `sub_city`, `company_address`, `about_company`, `email`, `mobile`, `password`, `code`) VALUES
(33, 'instatech', 'sunita', '0000-00-00 00:00:00', 'www.eitians.com', 'India', '3', '', 'dwarka', 'abc 23423', 'it company', 'anu@gmail.com', '7011768417', '@1234', 'C234');
...
CREATE TABLE `product` (
  ...
  `pro_price` int(123) NOT NULL,
  `pro_disc` decimal(10,2) NOT NULL,
  `pro_stock` int(50) NOT NULL,
...
CREATE TABLE `subcategory` (
  `sub_id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
  `sub_catName` varchar(256) NOT NULL,
  `pro_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
